...
@section('script')
    <script>
        ...
        $(document).on('click', '#button-side-form', function() {
            control.overlay_form('Tambah', 'Data Peminjaman');
        })
        ...
        $(document).on('submit', ".form-data", function(e) {
            ...
            if (type == 'update') {
                ...
                control.submitFormMultipartData('/biro/inventaris/data-peminjaman-update/' + uuid,
                    'Update',
                    'Data Peminjaman', 'POST');
            }
        });
                ...
                columnDefs: [{
                    ...
                    render: function(data, type, full, meta) {
                        return `
                            ...
                            <a href="javascript:;" type="button" data-uuid="${data}" data-label="Data Peminjaman" class="btn btn-danger button-delete btn-icon btn-sm ${full.role == 'biro' ? 'disabled' : ''}">
                                <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        //     e.preventDefault();
        //     window.open(`/biro/inventaris/data-peminjaman-export`, "_blank");
        // });
    </script>
@endsection
