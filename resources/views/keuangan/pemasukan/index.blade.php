...
@section('content')
    ...
    <div
        ...
        <div class="text-center text-md-start mb-5 mb-md-0">
            <h2 class="mb-1 mb-text-h2 mb-text-color-primary mb-brand-primary-color">Catat Pemasukan</h2>
...
@section('script')
    <script>
        ...
        $(document).on('submit', ".form-data", function(e) {
            ...
            if (type == 'add') {
                control.submitFormMultipartData('/biro/keuangan/pemasukan-store', 'Tambah',
                    'Pemasukan',
                    'POST');
            } else {
                let uuid = $("input[name='uuid']").val();
                control.submitFormMultipartData('/biro/keuangan/pemasukan-update/' + uuid,
                    'Update',
                    'Pemasukan', 'POST',
                    function success() {
        ...
        $(document).on('click', '.button-update', function(e) {
            e.preventDefault();
            let url = '/biro/keuangan/pemasukan-show/' + $(this).attr('data-uuid');
            control.overlay_form('Update', 'Campaign Donasi', url);
        })

        $(document).on('click', '.button-delete', function(e) {
            e.preventDefault();
            let url = '/biro/keuangan/pemasukan-delete/' + $(this).attr('data-uuid');
        ...
        //     e.preventDefault();
        //     window.open(`/biro/keuangan/pemasukan-export`, "_blank");
        // });
    </script>
@endsection
