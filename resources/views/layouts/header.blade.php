<div id="kt_header" class="mb-header-dashboard header align-items-stretch">
    ...
    <div class="container-fluid d-flex align-items-stretch justify-content-between">
                ...
                <span class="svg-icon svg-icon-2x mt-1">
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                        ...
                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                            ...
                            <rect fill="#FFF" x="4" y="5" width="16" height="3" rx="1.5" />
                            <path
        ...
        <div class="d-block d-lg-none d-flex justify-content-center align-items-center" id="#kt_header_menu"
            data-kt-menu="true">
                ...
                <div class="d-flex align-items-stretch flex-shrink-0">
                    ...
                    <div class="d-none d-md-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                        ...
                        {{-- <span class="bg-white text-primary"
                            style="width: 40px; height: 40px; position:relative; right:10px; border-radius: 5px; display: grid; justify-items: center; align-items: center; font-size: 14px; font-weight: 600">
                            @php
                                $role = Auth::user()->role;
                        ...
                        <!--begin::Toggle-->
                        <button type="button"
                            class="btn btn-outline btn-outline-dashed btn-outline-white btn-active-light-white rotate bg-transparent"
                            data-kt-menu-trigger="click" data-kt-menu-attach="parent"
                            data-kt-menu-placement="bottom-end" data-kt-menu-flip="bottom">
                            <div class="text-white">Hai, <span>{{ $username }}</span>
                            </div>
                            <span class="svg-icon svg-icon-3 rotate-180 ms-3 me-0">
                                ...
                                <svg width="24" height="24" viewBox="0 0 24 24" id="icon-top"
                                ...
                                <div class="menu-content d-flex align-items-center px-3">
                                    ...
                                    <div class="symbol symbol-50px me-5">
                                        <span class="bg-primary text-white"
                                            style="width: 40px; height: 40px; position:relative; border-radius: 5px; display: grid; justify-items: center; align-items: center; font-size: 14px; font-weight: 600">
                                            @php
                                                $role = Auth::user()->role;
                                                $username = auth()->user()->nama;
                                                $firstLetter = '';
                    ...
                    <div class="d-md-none d-flex align-items-center ms-1 ms-lg-3">
                        <form id="logout-form" action="{{ route('logout') }}" method="GET">
                            @csrf
                            <button type="submit" class="btn btn-icon w-30px h-30px w-md-40px h-md-40px" title="Keluar"
                                style="border: none;">
                                <!--begin::Font Awesome Logout Icon-->
                                <i class="fas fa-sign-out-alt text-white fs-3"></i>
                                <!--end::Font Awesome Logout Icon-->
                            </button>
                        </form>
                    </div>
