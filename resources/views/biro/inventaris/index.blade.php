...
@section('content')
    ...
    <div
        ...
        <div class="text-center text-md-start mb-5 mb-md-0">
            <h2 class="mb-1 mb-text-h2 mb-text-color-primary mb-brand-primary-color">Data Inventaris</h2>
            ...
            <div class="card-body hover-scroll-overlay-y">
                <form class="form-data" enctype="multipart/form-data">
                    ...
                    <div class="mb-10">
                        ...
                        <small class="text-danger no_inventaris_error"></small>
                    </div>
                    ...
                    <div class="mb-10">
                        ...
                        <small class="text-danger baik_error"></small>
                    </div>

                    <div class="mb-10">
                        <label class="form-label">Kurang Baik</label>
                        <input type="number" name="kurang_baik" class="form-control">
                        <small class="text-danger kurang_baik_error"></small>
                    </div>

                    <div class="mb-10">
                        <label class="form-label">Rusak</label>
                        <input type="number" name="rusak" class="form-control">
                        <small class="text-danger rusak_error"></small>
                    </div>

                    <div class="mb-10">
                        <label class="form-label">Keterangan</label>
                        <textarea name="keterangan" id="" cols="" rows="4" class="form-control"></textarea>
...
@section('script')
    <script>
        ...
        $(document).on('submit', ".form-data", function(e) {
            ...
            if (type == 'add') {
                control.submitFormMultipartData('/biro/inventaris/data-inventaris-store', 'Tambah',
                    'Data Inventaris',
                    'POST');
            } else {
                let uuid = $("input[name='uuid']").val();
                control.submitFormMultipartData('/biro/inventaris/data-inventaris-update/' + uuid,
                    'Update',
        ...
        $(document).on('click', '.button-update', function(e) {
            e.preventDefault();
            let url = '/biro/inventaris/data-inventaris-show/' + $(this).attr('data-uuid');
            control.overlay_form('Update', 'Data Inventaris', url);
        })

        $(document).on('click', '.button-delete', function(e) {
            e.preventDefault();
            let url = '/biro/inventaris/data-inventaris-delete/' + $(this).attr('data-uuid');
        ...
        const initDatatable = async () => {
            ...
            $('#kt_table_data').DataTable({
                ...
                processing: true,
                ajax: '/biro/inventaris/data-inventaris-get',
                columns: [{
                    data: null,
                    ...
                    data: 'jumlah',
                    className: 'mb-kolom-qty text-center align-content-center',
                }, {
                    data: 'satuan',
                    className: 'mb-kolom-qty text-center align-content-center',
                }, {
                    ...
                    data: 'keterangan',
                    className: 'mb-kolom-text  align-content-center',
                }, {
                    data: 'uuid',
                }],
                columnDefs: [{
                    ...
                    render: function(data, type, full, meta) {
                        return `
                            ...
                            <a href="javascript:;" type="button" data-uuid="${data}" data-label="Data Inventaris" class="btn btn-danger button-delete btn-icon btn-sm ${full.role == 'biro' ? 'disabled' : ''}">
                                <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        //     e.preventDefault();
        //     window.open(`/biro/inventaris/data-inventaris-export`, "_blank");
        // });
    </script>
@endsection
