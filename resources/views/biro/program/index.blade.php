...
@section('content')
    ...
    <div
        ...
        <div class="text-center text-md-start mb-5 mb-md-0">
            <h2 class="mb-1 mb-text-h2 mb-text-color-primary mb-brand-primary-color">Data Program Asrama</h2>
            ...
            <div class="card-body hover-scroll-overlay-y">
                <form class="form-data" enctype="multipart/form-data">
                    ...
                    <div class="mb-10">
                        ...
                        <small class="text-danger nama_program_error"></small>
                    </div>

                    <div class="mb-10">
                        <label class="form-label">Deskripsi</label>
                        <textarea name="deskripsi" id="" cols="" rows="2" class="form-control"></textarea>
                        <small class="text-danger deskripsi_error"></small>
                    </div>

                    <div class="mb-10">
                        <label class="form-label">Icon</label>
                        <input type="file" accept="image/*" id="icon" class="form-control" name="icon">
...
@section('script')
    <script>
        ...
        $(document).on('click', '#button-side-form', function() {
            control.overlay_form('Tambah', 'Program');
        })
        ...
        function previewImage(input) {
            ...
            if (input.files && input.files[0]) {
                ...
                logoError.text('Pilih file icon yang valid.');
        ...
        $(document).on('submit', ".form-data", function(e) {
            ...
            if (type == 'add') {
                control.submitFormMultipartData('/biro/kegiatan/program-store', 'Tambah',
                    'Program',
                    'POST');
            } else {
                let uuid = $("input[name='uuid']").val();
                control.submitFormMultipartData('/biro/kegiatan/program-update/' + uuid,
                    'Update',
                    'Program', 'POST');
            }
        });
        ...
        $(document).on('click', '.button-update', function(e) {
            ...
            $(".title_side_form").html(`Update Program`);
            $(".text-danger").html("");
            let url = '/biro/kegiatan/program-show/' + $(this).attr('data-uuid');
            $.ajax({
                url: url,
                method: "GET",
                    ...
                    if (res.success == true) {
                        ...
                        $.each(res.data, function(x, y) {
                            ...
                            if ($("input[name='" + x + "']").is(":radio")) {
                                ...
                                $('#logoInfoContainer').html(
                                    `<img id="img-foto" src="/public/program/${y}" style="max-width:100%;">`
                                );
                            } else {
                                $("input[name='" + x + "']").val(y);
        ...
        $(document).on('click', '.button-delete', function(e) {
            e.preventDefault();
            let url = '/biro/kegiatan/program-delete/' + $(this).attr('data-uuid');
        ...
        const initDatatable = async () => {
            ...
            $('#kt_table_data').DataTable({
                ...
                processing: true,
                ajax: '/biro/kegiatan/program-get',
                columns: [{
                    data: 'nama_program',
                    ...
                    render: function(data, type, row, meta) {
                        ...
                        result =
                            `
                                <!--begin::Overlay-->
                                <a class="d-block overlay fancybox" data-fancybox="lightbox-group" href="{{ asset('/public/program/${data}') }}">
                                    <!--begin::Image-->
                                    <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-100px"
                                        style="background-image:url('/public/program/${data}')">
                                    </div>
                                    <!--end::Image-->
                ...
                columnDefs: [{
                    ...
                    render: function(data, type, full, meta) {
                        return `
                            ...
                            <a href="javascript:;" type="button" data-uuid="${data}" data-label="Program" class="btn btn-danger button-delete btn-icon btn-sm ${full.role == 'biro' ? 'disabled' : ''}">
                                <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        //     e.preventDefault();
        //     window.open(`/biro/kegiatan/program-export`, "_blank");
        // });
    </script>
@endsection
