...
@section('content')
    ...
    <div
        ...
        <div class="text-center text-md-start mb-5 mb-md-0">
            <h2 class="mb-1 mb-text-h2 mb-text-color-primary mb-brand-primary-color">Jadwal & Agenda</h2>
            ...
            <div class="card-body hover-scroll-overlay-y">
                <form class="form-data" enctype="multipart/form-data">
                    ...
                    <div class="mb-10">
                        ...
                        <input type="text" name="jadwal_pelaksanaan" class="form-control kt_datepicker_7">
                        <small class="text-danger jadwal_pelaksanaan_error"></small>
                    </div>

                    <div class="mb-10">
                        <label class="form-label">Foto</label>
                        <input type="file" accept="image/*" id="foto_absen" class="form-control" name="foto_absen">
                        <small class="text-danger foto_absen_error"></small>
...
@section('script')
    <script>
        ...
        $(document).on('click', '#button-side-form', function() {
            control.overlay_form('Tambah', 'Jadwal & Agenda');
        })

        $('#foto_absen').change(function() {
            previewImage(this);
        });
                    ...
                    if (res.success == true) {
                        ...
                        $.each(res.data, function(x, y) {
                            ...
                            if ($("input[name='" + x + "']").is(":radio")) {
                                ...
                                $('#logoInfoContainer').html(
                                    `<img id="img-foto" src="/public/absen/${y}" style="max-width:100%;">`
                                );
                            } else {
                                $("input[name='" + x + "']").val(y);
                            ...
                            result =
                                ...
                                <a class="d-block overlay fancybox" data-fancybox="lightbox-group" href="{{ asset('/public/absen/${data}') }}">
                                    ...
                                    <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-100px"
                                        style="background-image:url('/public/absen/${data}')">
                                    </div>
                                    <!--end::Image-->
                ...
                columnDefs: [{
                    ...
                    render: function(data, type, full, meta) {
                        return `
                            ...
                            <a href="javascript:;" type="button" data-uuid="${data}" data-label="Jadwal & Agenda" class="btn btn-danger button-delete btn-icon btn-sm ${full.role == 'biro' ? 'disabled' : ''}">
                                <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
