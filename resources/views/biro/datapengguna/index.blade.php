...
@section('content')
    ...
    <div
        ...
        <div class="text-center text-md-start mb-5 mb-md-0">
            <h2 class="mb-1 mb-text-h2 mb-text-color-primary mb-brand-primary-color">Kelola Data Pengelola</h2>
            ...
            <div class="card-body hover-scroll-overlay-y">
                <form class="form-data" enctype="multipart/form-data">
                    ...
                    <div class="mb-10">
                        ...
                        <select name="role" class="form-control" data-control="select2">
...
@section('script')
    <script>
        ...
        $(document).on('click', '#button-side-form', function() {
            control.overlay_form('Tambah', 'Data Pengelola');
        })
        ...
        $(document).on('submit', ".form-data", function(e) {
            ...
            if (type == 'add') {
                control.submitFormMultipartData('/biro/data-pengguna-store', 'Tambah',
                    'Data Pengelola',
                    'POST');
            } else {
                let uuid = $("input[name='uuid']").val();
                control.submitFormMultipartDataPengguna('/biro/data-pengguna-update/' + uuid,
                    'Update',
                    'Data Pengelola', 'POST',
                    function success() {
        ...
        $(document).on('click', '.button-update', function(e) {
            ...
            $(".title_side_form").html(`Update Data Pengelola`);
            $(".text-danger").html("");
            let url = '/biro/data-pengguna-show/' + $(this).attr('data-uuid');
            $.ajax({
                url: url,
                method: "GET",
                    ...
                    if (res.success == true) {
                        $.each(res.data, function(x, y) {
                            ...
                            if ($("input[name='" + x + "']").is(":radio")) {
                                ...
                                logoInfoContainer.html(
                                    `<img id="img-foto" src="/public/pengguna/${y}" style="max-width:100%;">`
                                );
        ...
        $(document).on('click', '.button-delete', function(e) {
            e.preventDefault();
            let url = '/biro/data-pengguna-delete/' + $(this).attr('data-uuid');
                ...
                columns: [{
                    ...
                    render: function(data, type, row, meta) {
                        ...
                        if (data) {
                            ...
                            result =
                                `
                                    <div class="mb-profil-pengguna brand-accent-color d-flex align-items-center justify-content-center mx-auto">
                ...
                columnDefs: [{
                    ...
                    render: function(data, type, full, meta) {
                        return `
                            ...
                            <a href="javascript:;" type="button" data-uuid="${data}" data-label="Data Pengelola" class="btn btn-danger button-delete btn-icon btn-sm ${full.role == 'biro' ? 'disabled' : ''}">
                                <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        //     e.preventDefault();
        //     window.open(`/biro/data-pengguna-export`, "_blank");
        // });
    </script>
@endsection
